...
?>
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
        <?php echo form_open('login/login_validation', array('class' => 'login-form')); ?>
        <div class="row">
        ...
        <div class="row">
          <div class="input-field col s6 m6 l6">
            <p class="margin medium-small"><a href="<?=base_url();?>welcome/registration"><?=lang('register_now');?></a></p>
          </div>
          <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small"><a href="<?=base_url();?>login/forget"><?=lang('forgot_password');?> ?</a></p>
          </div>          
        </div>
