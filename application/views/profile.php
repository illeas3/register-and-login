                    ...
                    <div id="profile-page-header" class="card">
                        ...
                        <div class="card-content">
                          <div class="row">                    
                            <div class="col s3 offset-s2">                        
                                ...
                                <p class="medium-small grey-text"><?php if($user->userRole==1){ echo lang('user'); }else{ echo lang('user'); }?></p>                        
                            </div>
                        ...
                        <div class="card-reveal">
                            <p>
                              ...
                              <span><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> <?php if($user->userRole==1){ echo "User"; }else{ echo "User"; }?></span>
                            </p>
