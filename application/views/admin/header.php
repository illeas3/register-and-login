...
<head>
  ...
  <script type="text/javascript">
    function getlanguage(val) {
       $.ajax({  
            url:"<?php echo base_url();?>admin/getlanguage",  
            method:"POST",  
            data:{val:val},  
            success:function(a)  
            { 
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="<?=base_url();?>admin" class="brand-logo darken-1"><img src="<?=base_url();?>assets/images/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">Loop-tech</span></h1></li>
                    </ul>
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        <li><a href="#" class="waves-effect waves-block waves-light notification-button" data-activates="notifications-dropdown"><i class="mdi-social-notifications"><small class="notification-badge">5</small></i>
