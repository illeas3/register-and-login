          ...
          <div id="profile-page" class="section">
            ...
            <div id="profile-page-header" class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="<?=base_url();?>assets/images/user-profile-bg.jpg" alt="user background">                    
                </div>
                <figure class="card-profile-image">
                    <img src="<?=base_url();?>assets/images/avatar.jpg" alt="profile image" class="circle z-depth-2 responsive-img activator">
                </figure>
                <div class="card-content">
                  <div class="row">                    
                    <div class="col s3 offset-s2">                        
                        <h4 class="card-title grey-text text-darken-4"><?=$user->first_name." ".$user->last_name;?></h4>
                        <p class="medium-small grey-text"><?php if($user->userRole==1){ echo "Administrator"; }else{ echo "Editor"; }?></p>                        
                    </div>
                ...
                <div class="card-reveal">
                    <p>
                      <span class="card-title grey-text text-darken-4"><?=$user->first_name." ".$user->last_name;?> <i class="mdi-navigation-close right"></i></span>
                      <span><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> <?php if($user->userRole==1){ echo "Administrator"; }else{ echo "Editor"; }?></span>
                    </p>

                    <p>I am a very simple card. I am good at containing small bits of information. I am convenient because I require little markup to use effectively.</p>
                    
                    <p><i class="mdi-action-perm-phone-msg cyan-text text-darken-2"></i> <?=$user->contact;?></p>
                ...
                <div id="profile-page-wall-share" class="row">
                  <div class="col s12">
                    ...
                    <div id="UpdateStatus" class="tab-content col s12  grey lighten-4">
                      <div class="row">
                        <div class="col s2">
                          <img src="<?=base_url();?>assets/images/avatar.jpg" alt="" class="circle responsive-img valign profile-image-post">
                        </div>
                  ...
                  <div class="col s12">
                      ...
                      <div id="profile-page-wall-post" class="card">
                        <div class="card-profile-title">
                          <div class="row">
                            <div class="col s1">
                              <img src="<?=base_url();?>assets/images/avatar.jpg" alt="" class="circle responsive-img valign profile-post-uer-image">                        
                            </div>
                            <div class="col s10">
                              <p class="grey-text text-darken-4 margin"><?=$user->first_name." ".$user->last_name;?></p>
                        ...
                        <div class="card-image profile-medium">                          
                          <img src="<?=base_url();?>assets/images/gallary/2.jpg" alt="sample" class="responsive-img profile-post-image profile-medium">                        
                      ...
                      <div id="profile-page-wall-post" class="card">
                        ...
                        <div class="card-image profile-small">
                          <img src="<?=base_url();?>assets/images/gallary/1.jpg" alt="sample" class="responsive-img profile-post-image">                        
                          <span class="card-title">Card Title</span>
                        </div>
                        <div class="card-content">
                          <p>I am a very simple card. I am good at containing small bits of information. I am convenient because I require little markup to use effectively.</p>
