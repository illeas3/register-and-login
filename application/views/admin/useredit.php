        ...
        <div class="container">
          <div id="login-page" class="row">
            <div class="col s12 z-depth-4 card-panel">
                <?php echo form_open('admin/usereditdetails', array('class' => 'login-form')); ?>
                <div class="row">
                ...
                <div class="row margin">
                  <div class="input-field col s12">
                    ...
                    <input id="name3" name="first_name" required="" type="text" value="<?=$users->first_name;?>">
                ...
                <div class="row margin">
                  <div class="input-field col s12">
                    <i class="mdi-social-person-outline prefix"></i>
                    <input id="name3" name="last_name" required="" type="text" value="<?=$users->last_name;?>">
                ...
                <div class="row margin">
                  <div class="input-field col s12">
                    ...
                    <input id="email" type="email" name="email" required="" value="<?=$users->email;?>">
                    <label for="email" class="center-align"><?=lang('email');?></label>
                  </div>
                </div>
                <div class="row margin">
                  <div class="input-field col s12">
                    <input id="contact" name="contact" required="" type="number" value="<?=$users->contact;?>">
                ...
                <div class="row margin">
                  <div class="input-field col s12">
                    ...
                    <input type="hidden" name="oldpass" value="<?=$users->password;?>">
                ...
                <div class="row">
                  ...
                  <div class="input-field col s12">
                    <a href="<?=base_url();?>admin/userlist" class="btn waves-effect waves-light col s12" type="submit" name="action"><?=lang('cancel');?></a>
                  </div>
                </div><br>
              </form>
            </div>
