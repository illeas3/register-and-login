...
$user=$this->db->get_where('admin' , array('id' => $id))->row();
 ?>
            ...
            <div class="row">
                ...
                <div class="col col s8 m8 l8">
                    <ul id="profile-dropdown" class="dropdown-content">
                        <li><a href="<?=base_url();?>admin/profile"><i class="mdi-action-face-unlock"></i><?=lang('profile');?></a>
                        </li>
                        <li><a href="<?=base_url();?>admin/settings"><i class="mdi-action-settings"></i> <?=lang('settings');?></a>
                        </li>
                        ...
                        <li><a href="<?=base_url();?>admin/logout"><i class="mdi-hardware-keyboard-tab"></i><?=lang('Logout');?></a>
                        </li>
                    </ul>
                    ...
                    <p class="user-roal"><?php if($user->userRole==1){ echo lang('administrator'); }else{ echo lang('editor'); }?></p>
                </div>
            </div>
            </li>
            <li class="bold"><a href="<?=base_url();?>admin" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i><?=lang('dashboard');?></a>
            </li>
            <li class="bold"><a href="<?=base_url();?>admin/userlist" class="waves-effect waves-cyan"><i class="mdi-social-group"></i><?=lang('user_list');?></a>
            </li>
            <!-- <li class="no-padding">
