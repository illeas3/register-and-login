 ...
 <!-- START FOOTER -->
    <footer class="page-footer">
        <div class="footer-copyright">
            <div class="container">
                <?=lang('copyright');?> &copy; <?=date("Y");?> <a class="grey-text text-lighten-4" href="http://loop-tech.net" target="_blank">Loop-tech</a> <?=lang('all_rights_reserved');?>.
    ...
    <!-- google map api -->
    <script type="text/javascript" src="<?=base_url();?>assets/https://maps.googleapis.com/maps/api/js?key=AIzaSyAAZnaZBXLqNBRXjd-82km_NO7GUItyKek"></script>
